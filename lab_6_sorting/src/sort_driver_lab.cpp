...
int main(int argc, const char **argv)
{
  ...
  if(seed == -1) {
    v.push_back(2.51);  v.push_back(2.09);  v.push_back(9.41);  v.push_back(4.23);  v.push_back(3.96);  v.push_back(3.83); v.push_back(2.32);  v.push_back(5.36);  v.push_back(5.33);  v.push_back(8.63); v.push_back(9.62);  v.push_back(3.15);  v.push_back(7.36);  v.push_back(6.55);  v.push_back(0.50); v.push_back(4.54);
    ...
    for (it = 0; it < iterations; it++) {
     ...
     v.push_back(2.51),  v.push_back(2.09),  v.push_back(9.41),  v.push_back(4.23),  v.push_back(3.96),  v.push_back(3.83),  v.push_back(2.32),  v.push_back(5.36),  v.push_back(5.33),  v.push_back(8.63),  v.push_back(9.62),  v.push_back(3.15),  v.push_back(7.36);
